...
type EthAPI interface {
	...
	GetWitness(ctx context.Context, blockNr rpc.BlockNumberOrHash) (hexutility.Bytes, error)
	GetTxWitness(ctx context.Context, blockNr rpc.BlockNumberOrHash, txIndex hexutil.Uint) (hexutility.Bytes, error)
