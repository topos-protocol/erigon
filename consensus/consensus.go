...
type EngineWriter interface {
	...
	Prepare(chain ChainHeaderReader, header *types.Header, state *state.IntraBlockState, validators ValidatorSet) error
...
type Istanbul interface {
	...
	Start(chain ChainHeaderReader, currentBlock func() *types.Block, hasBadBlock func(db kv.RwDB, hash common.Hash) bool) error
